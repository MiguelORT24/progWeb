...
<h2><i class="fa fa-arrow-down"></i> Registrar Entrada de Inventario</h2>
...
<form method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="movimiento_motivo" name="movimiento_motivo" 
               value="<?= $data['movimiento_motivo'] ?? '' ?>" placeholder="Ej: Compra a proveedor, Devolución, etc.">
    </div>

    <div class="mb-3">
        <button type="submit" class="btn btn-success"><i class="fa fa-save"></i> Registrar Entrada</button>
